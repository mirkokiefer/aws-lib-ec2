...
module.exports = {
  ...
  mapAssociateAddressResponse: mapAssociateAddressResponse
}
...
function mapAssociateAddressResponse(res) {
  var success = res.return == "true"
  if (!success) {
    return {error: true, message: res.return}
  }
  return {success: true}
}
